...
namespace Durian.DefaultParam
{
	...
	public class DefaultParamGenerator : SourceGenerator<DefaultParamCompilationData, DefaultParamSyntaxReceiver, IDefaultParamFilter>
	{
		...
		public DefaultParamGenerator() : this(false, true, false, new SymbolNameToFile())
		{
		}

		public DefaultParamGenerator(bool checkForConfigurationAttribute, bool enableLoggingIfSupported = true, bool enableDiagnosticsIfSupported = true) : this(checkForConfigurationAttribute, enableLoggingIfSupported, enableDiagnosticsIfSupported, new SymbolNameToFile())
		{
		}
		...
		public DefaultParamGenerator(GeneratorLoggingConfiguration loggingConfiguration) : this(loggingConfiguration, new SymbolNameToFile())
		{
		}
		...
		protected sealed override bool Generate(IMemberData data, string hintName, IDefaultParamFilter filter, in GeneratorExecutionContext context)
		{
