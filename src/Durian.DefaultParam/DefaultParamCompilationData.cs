...
namespace Durian.Analysis.DefaultParam
{
	...
	public sealed class DefaultParamCompilationData : CompilationDataWithSymbols
	{
		...
		/// <summary>
		/// <see cref="DefaultParamConfiguration"/> created from the <see cref="Configuration.DefaultParamScopedConfigurationAttribute"/> defined on the <see cref="CompilationData.Compilation"/>'s main assembly. -or- <see cref="DefaultParamConfiguration.Default"/> if no <see cref="Configuration.DefaultParamScopedConfigurationAttribute"/> was found.
		/// </summary>
		...
		/// <summary>
		/// Creates a new instance of <see cref="DefaultParamConfiguration"/> based on the <see cref="Configuration.DefaultParamScopedConfigurationAttribute"/> defined on the <paramref name="compilation"/>'s main assembly or <see cref="DefaultParamConfiguration.Default"/> if no <see cref="Configuration.DefaultParamScopedConfigurationAttribute"/> was found.
		/// </summary>
		...
		private static DefaultParamConfiguration GetConfiguration(CSharpCompilation compilation, INamedTypeSymbol? configurationAttribute)
		{
			...
			foreach (AttributeData attribute in compilation.Assembly.GetAttributes())
			{
				...
				{
					bool applyNewModififer = !attribute.TryGetNamedArgumentValue(nameof(Configuration.DefaultParamScopedConfigurationAttribute.ApplyNewModifierWhenPossible), out bool value) || value;
					DPMethodConvention methodCon = (DPMethodConvention)DefaultParamUtilities.GetValidConventionEnumValue(attribute.GetNamedArgumentValue<int>(nameof(Configuration.DefaultParamScopedConfigurationAttribute.MethodConvention)));
					DPTypeConvention typeCon = (DPTypeConvention)DefaultParamUtilities.GetValidConventionEnumValue(attribute.GetNamedArgumentValue<int>(nameof(Configuration.DefaultParamScopedConfigurationAttribute.TypeConvention)));
					string? @namespace = attribute.GetNamedArgumentValue<string>(nameof(Configuration.DefaultParamScopedConfigurationAttribute.TargetNamespace));
