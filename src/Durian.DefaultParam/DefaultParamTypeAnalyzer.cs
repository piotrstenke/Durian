...
namespace Durian.Analysis.DefaultParam
{
	...
	public sealed class DefaultParamTypeAnalyzer : DefaultParamAnalyzer
	{
		...
		/// <inheritdoc cref="DefaultParamDelegateAnalyzer.Analyze(INamedTypeSymbol, DefaultParamCompilationData, IDiagnosticReceiver, CancellationToken)"/>
		...
		/// <inheritdoc cref="DefaultParamDelegateAnalyzer.AnalyzeCollidingMembers(INamedTypeSymbol, in TypeParameterContainer, DefaultParamCompilationData, string, out HashSet{int}?, IDiagnosticReceiver, IEnumerable{AttributeData}?, INamedTypeSymbol[], CancellationToken)"/>
		...
		/// <inheritdoc cref="DefaultParamDelegateAnalyzer.AnalyzeCollidingMembers(INamedTypeSymbol, in TypeParameterContainer, DefaultParamCompilationData, string, out HashSet{int}?, bool, IDiagnosticReceiver, CancellationToken)"/>
		public static bool AnalyzeCollidingMembers(
			INamedTypeSymbol symbol,
			in TypeParameterContainer typeParameters,
			DefaultParamCompilationData compilation,
		...
		{
			return DefaultParamDelegateAnalyzer.AnalyzeCollidingMembers(
				symbol,
				in typeParameters,
				compilation,
				targetNamespace,
