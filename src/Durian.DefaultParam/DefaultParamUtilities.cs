	...
	internal static class DefaultParamUtilities
	{
		...
		public static IEnumerator<T> GetFilterEnumerator<T>(IDefaultParamFilter<T> filter) where T : class, IDefaultParamTarget
		{
			...
			return filter.Mode switch
			{
				...
				FilterMode.Both => new DefaultParamFilterEnumerator<T>(filter, LoggableGenerator.LoggableDiagnosticReceiverFactory.SourceGenerator(generator, generator.DiagnosticReceiver!)),
		...
		public static IEnumerator<T> GetFilterEnumerator<T>(IDefaultParamFilter<T> filter, in CachedData<T> cache) where T : class, IDefaultParamTarget
		{
			...
			return filter.Mode switch
			{
				...
				FilterMode.Both => new CachedDefaultParamFilterEnumerator<T>(filter, LoggableGenerator.LoggableDiagnosticReceiverFactory.SourceGenerator(generator, generator.DiagnosticReceiver!), in cache),
		...
		public static T[] IterateFilter<T>(IDefaultParamFilter<T> filter) where T : class, IDefaultParamTarget
		{
			...
			switch (filter.Mode)
			{
				...
				{
					DefaultParamFilterEnumerator<T> enumerator = new(filter, LoggableGenerator.LoggableDiagnosticReceiverFactory.SourceGenerator(generator, generator.DiagnosticReceiver!));
		...
		public static T[] IterateFilter<T>(IDefaultParamFilter<T> filter, in CachedData<T> cache) where T : class, IDefaultParamTarget
		{
			...
			switch (filter.Mode)
			{
				...
				case FilterMode.Both:
				{
					CachedDefaultParamFilterEnumerator<T> enumerator = new(filter, LoggableGenerator.LoggableDiagnosticReceiverFactory.SourceGenerator(generator, generator.DiagnosticReceiver!), in cache);
