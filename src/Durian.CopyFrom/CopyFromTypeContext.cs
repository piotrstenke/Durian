...
{
	/// <summary>
	/// <see cref="ISyntaxValidatorContext"/> used during analysis of methods marked with the <c>Durian.CopyFromTypeAttribute</c>.
	/// </summary>
	public readonly struct CopyFromTypeContext : ISyntaxValidatorContext
	{
		/// <inheritdoc/>
