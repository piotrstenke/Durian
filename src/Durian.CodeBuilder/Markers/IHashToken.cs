...
{
	/// <summary>
	/// Provides a method for writing the hash'#' token.
	/// </summary>
	/// <typeparam name="TReturn">Type of returned builder.</typeparam>
	public interface IHashToken<out TReturn> : IWhiteSpace where TReturn : class
	{
	}
}
...
namespace Durian.Builder
{
	...
	{
		internal partial class Adapter : IHashToken<IWhiteSpace>
		{
		}
	}
	...
	public static partial class RawCodeBuilderExtensions
	{
		...
		public static T Hash<T>(this IHashToken<T> builder) where T : class
		{
