...
namespace Durian.Info
{
	...
	public static class ModuleRepository
	{
		...
		/// <summary>
		/// Returns a <see cref="ModuleIdentity"/> for the <see cref="DurianModule.GlobalScope"/> module.
		/// </summary>
		public static ModuleIdentity GlobalScope
		{
			get
			{
				if(!IdentityPool.Modules.TryGetValue("GlobalScope", out ModuleIdentity module))
				{
					module = new(
						module: DurianModule.GlobalScope,
						id: 05,
						packages: new DurianPackage[]
						{
							DurianPackage.GlobalScope,
						},
						docsPath: "https://github.com/piotrstenke/Durian/tree/master/docs/GlobalScope",
						diagnostics: new DiagnosticData[]
						{
							new DiagnosticData(
								title: "Type marked with the GlobalScopeAttribute must be static",
								id: 01,
								docsPath: "https://github.com/piotrstenke/Durian/tree/master/docs/GlobalScope/DUR0501.md",
								fatal: true,
								hasLocation: true
							),
							...
							new DiagnosticData(
								...
								id: 02,
								docsPath: "https://github.com/piotrstenke/Durian/tree/master/docs/GlobalScope/DUR0502.md",
								fatal: true,
								hasLocation: true
							),
							...
							new DiagnosticData(
								...
								id: 03,
								docsPath: "https://github.com/piotrstenke/Durian/tree/master/docs/GlobalScope/DUR0503.md",
								fatal: true,
								hasLocation: true
							),
						},
						types: new TypeIdentity[]
						{
							TypeRepository.GlobalScopeAttribute,
						}
					);
				}
