...
{
	/// <summary>
	/// A delegate that mirrors the signature of the <see cref="DurianGeneratorWithContext{TCompilationData, TSyntaxReceiver, TFilter}.Initialize(GeneratorInitializationContext)"/> method.
	/// </summary>
