...
DUR0006 | Durian | Error | Target project must use C# 9 or newer. [[DOC](https://github.com/piotrstenke/Durian/tree/master/docs/CoreAnalyzer/DUR0006.md)]
...
Rule ID | Category | Severity | Notes
--------|----------|----------|-----------------------------------------
DUR0007 | Durian | Error | Do not reference Durian analyzer package if the main Durian package is already included. [[DOC](https://github.com/piotrstenke/Durian/tree/master/docs/CoreAnalyzer/DUR0007.md)]
