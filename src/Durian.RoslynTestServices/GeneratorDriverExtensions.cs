...
namespace Durian.Tests
{
	...
	public static class GeneratorDriverExtensions
	{
		...
		/// <exception cref="ArgumentNullException"><paramref name="generatorDriver"/> was <c>null</c>. -or- <paramref name="resultProvider"/> was <c>null</c>.</exception>
		...
		/// <exception cref="ArgumentNullException"><paramref name="generatorDriver"/> was <c>null</c>. -or- <paramref name="resultProvider"/> was <c>null</c>. -or- <paramref name="compilation"/> was <c>null</c>.</exception>
