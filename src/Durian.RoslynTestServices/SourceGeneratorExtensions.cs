...
namespace Durian.Tests
{
	...
	public static class SourceGeneratorExtensions
	{
		...
		/// <exception cref="ArgumentNullException"><paramref name="generator"/> was <c>null</c>. -or- <paramref name="resultProvider"/> was <c>null</c>.</exception>
		...
		/// <exception cref="ArgumentNullException"><paramref name="generator"/> was <c>null</c>. -or- <paramref name="resultProvider"/> was <c>null</c>. -or- <paramref name="compilation"/> was <c>null</c>.</exception>
