...
namespace Durian.Tests
{
	...
	public static class SourceGeneratorExtensions
	{
		...
		/// <exception cref="ArgumentNullException"><paramref name="generator"/> is <c>null</c>. -or- <paramref name="resultProvider"/> is <c>null</c>.</exception>
		...
		/// <exception cref="ArgumentNullException"><paramref name="generator"/> is <c>null</c>. -or- <paramref name="resultProvider"/> is <c>null</c>. -or- <paramref name="compilation"/> is <c>null</c>.</exception>
