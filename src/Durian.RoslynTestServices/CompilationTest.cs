...
namespace Durian.Tests
{
	...
	public abstract class CompilationTest
	{
		...
		/// <c>null</c> if no such <see cref="ClassDeclarationSyntax"/> exists.
		/// </returns>
		...
		/// <c>null</c> if no such <see cref="StructDeclarationSyntax"/> exists.
		/// </returns>
		...
		/// <c>null</c> if no such <see cref="InterfaceDeclarationSyntax"/> exists.
		/// </returns>
		...
		/// <c>null</c> if no such <see cref="RecordDeclarationSyntax"/> exists.
		/// </returns>
		...
		/// <c>null</c> if no such <see cref="MemberDeclarationSyntax"/> exists.
		/// </returns>
		...
		/// <c>null</c> if no such <see cref="TypeDeclarationSyntax"/> exists.
		/// </returns>
		...
		/// <c>null</c> if no such <see cref="FieldDeclarationSyntax"/> exists.
		/// </returns>
		...
		/// <c>null</c> if no such <see cref="PropertyDeclarationSyntax"/> exists.
		/// </returns>
		...
		/// <c>null</c> if no such <see cref="EventDeclarationSyntax"/> exists.
		/// </returns>
		...
		/// <c>null</c> if no such <see cref="EventFieldDeclarationSyntax"/> exists.
		/// </returns>
		...
		/// <c>null</c> if no such <see cref="DelegateDeclarationSyntax"/> exists.
		/// </returns>
		...
		/// <c>null</c> if no such <see cref="MethodDeclarationSyntax"/> exists.
		/// </returns>
