...
{
	/// <summary>
	/// Contains <see cref="DiagnosticDescriptor"/>s of all the <see cref="Diagnostic"/>s that can be reported by the <see cref="IntfTargAnalyzer"/>.
	/// </summary>
	public static class IntfTargDiagnostics
	{
		/// <summary>
