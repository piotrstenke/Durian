...
namespace Durian.Analysis
{
	...
	/// </summary>
	public readonly struct DurianExecutionContext : IDirectDiagnosticReceiver
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="DurianExecutionContext"/> struct.
		/// </summary>
		/// <param name="context"><see cref="GeneratorExecutionContext"/> to wrap.</param>
		public DurianExecutionContext(in GeneratorExecutionContext context)
		{
			_context = context;
