...
public sealed class WritableNamespaceOrTypeContainer<TData> : WritableSymbolContainer<INamespaceOrTypeSymbol, INamespaceOrTypeData> where TData : class, INamespaceOrTypeData
{
	/// <summary>
	/// Initializes a new instance of the <see cref="WritableNamespaceOrTypeContainer{TData}"/> class.
	/// </summary>
	public WritableNamespaceOrTypeContainer()
	{
	}
	...
	public WritableNamespaceOrTypeContainer(ICompilationData? parentCompilation, ISymbolNameResolver? nameResolver = default) : base(parentCompilation, nameResolver)
	{
	}
	...
	public WritableNamespaceOrTypeContainer(IEnumerable<INamespaceOrTypeSymbol> collection, ICompilationData? parentCompilation = default, ISymbolNameResolver? nameResolver = default) : base(collection, parentCompilation, nameResolver)
	{
	}
	...
	/// <param name="nameResolver"><see cref="ISymbolNameResolver"/> used to resolve names of symbols when <see cref="ISymbolContainer.GetNames"/> is called.</param>
	/// <exception cref="ArgumentNullException"><paramref name="collection"/> is <see langword="null"/>.</exception>
	public WritableNamespaceOrTypeContainer(IEnumerable<ISymbolOrMember<INamespaceOrTypeSymbol, INamespaceOrTypeData>> collection, ICompilationData? parentCompilation = default, ISymbolNameResolver? nameResolver = default) : base(collection, parentCompilation, nameResolver)
	{
	}
