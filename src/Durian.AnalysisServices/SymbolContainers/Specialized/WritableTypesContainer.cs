...
namespace Durian.Analysis.SymbolContainers.Specialized
{
	...
	public sealed class WritableTypesContainer<TData> : WritableSymbolContainer<INamedTypeSymbol, TData> where TData : class, ITypeData
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="WritableTypesContainer{TData}"/> class.
		/// </summary>
		public WritableTypesContainer()
		{
		}
		...
		public WritableTypesContainer(ICompilationData? parentCompilation, ISymbolNameResolver? nameResolver = default) : base(parentCompilation, nameResolver)
		{
		}
		...
		public WritableTypesContainer(IEnumerable<INamedTypeSymbol> collection, ICompilationData? parentCompilation = default, ISymbolNameResolver? nameResolver = default) : base(collection, parentCompilation, nameResolver)
		{
		}
		...
		/// <param name="nameResolver"><see cref="ISymbolNameResolver"/> used to resolve names of symbols when <see cref="ISymbolContainer.GetNames"/> is called.</param>
		/// <exception cref="ArgumentNullException"><paramref name="collection"/> is <see langword="null"/>.</exception>
		public WritableTypesContainer(IEnumerable<ISymbolOrMember<INamedTypeSymbol, TData>> collection, ICompilationData? parentCompilation = default, ISymbolNameResolver? nameResolver = default) : base(collection, parentCompilation, nameResolver)
		{
		}
