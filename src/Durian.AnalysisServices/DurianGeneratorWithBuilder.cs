...
namespace Durian.Analysis
{
	...
	public abstract class DurianGeneratorWithBuilder<TContext> : DurianGenerator<TContext> where TContext : GeneratorPassBuilderContext
	{
		...
		protected void WriteGeneratedMember(CSharpSyntaxNode generated, IMemberData original, TContext context, GenerateInheritdoc applyInheritdoc = GenerateInheritdoc.WhenPossible)
		{
		...
		/// <param name="context">Current <typeparamref name="TContext"/>.</param>
		/// <param name="applyInheritdoc">Determines when to apply the <c>&lt;inheritdoc/&gt;</c> tag.</param>
		protected void WriteGeneratedMember(string generated, IMemberData original, TContext context, GenerateInheritdoc applyInheritdoc = GenerateInheritdoc.WhenPossible)
		{
		...
		/// <param name="context">Current <typeparamref name="TContext"/>.</param>
		/// <param name="applyInheritdoc">Determines when to apply the <c>&lt;inheritdoc/&gt;</c> tag.</param>
		protected void WriteGeneratedMember(CSharpSyntaxNode generated, ISymbol original, TContext context, GenerateInheritdoc applyInheritdoc = GenerateInheritdoc.WhenPossible)
		{
			WriteGeneratedMember(NodeToString(generated), original, context, applyInheritdoc);
		}
		...
		/// <param name="context">Current <typeparamref name="TContext"/>.</param>
		/// <param name="applyInheritdoc">Determines when to apply the <c>&lt;inheritdoc/&gt;</c> tag.</param>
		protected void WriteGeneratedMember(string generated, ISymbol original, TContext context, GenerateInheritdoc applyInheritdoc = GenerateInheritdoc.WhenPossible)
		{
		...
		/// <param name="context">Current <typeparamref name="TContext"/>.</param>
		/// <param name="applyInheritdoc">Determines when to apply the <c>&lt;inheritdoc/&gt;</c> tag.</param>
		protected void WriteGeneratedMembers(CSharpSyntaxNode[] generated, IMemberData original, TContext context, GenerateInheritdoc applyInheritdoc = GenerateInheritdoc.WhenPossible)
		{
		...
		/// <param name="context">Current <typeparamref name="TContext"/>.</param>
		/// <param name="applyInheritdoc">Determines when to apply the <c>&lt;inheritdoc/&gt;</c> tag.</param>
		protected void WriteGeneratedMembers(string[] generated, IMemberData original, TContext context, GenerateInheritdoc applyInheritdoc = GenerateInheritdoc.WhenPossible)
		{
		...
		/// <param name="context">Current <typeparamref name="TContext"/>.</param>
		/// <param name="applyInheritdoc">Determines when to apply the <c>&lt;inheritdoc/&gt;</c> tag.</param>
		protected void WriteGeneratedMembers(CSharpSyntaxNode[] generated, ISymbol original, TContext context, GenerateInheritdoc applyInheritdoc = GenerateInheritdoc.WhenPossible)
		{
			WriteGeneratedMembers(ConvertString(generated), original, context, applyInheritdoc);
		}
		...
		/// <param name="context">Current <typeparamref name="TContext"/>.</param>
		/// <param name="applyInheritdoc">Determines when to apply the <c>&lt;inheritdoc/&gt;</c> tag.</param>
		protected void WriteGeneratedMembers(string[] generated, ISymbol original, TContext context, GenerateInheritdoc applyInheritdoc = GenerateInheritdoc.WhenPossible)
		{
			if (generated.Length == 0)
			{
				return;
		...
		private void WriteGeneratedMember_Internal(string generated, string generatedFrom, TContext context)
		{
		...
		private void WriteGeneratedMember_Internal(string generated, string generatedFrom, string inheritdoc, TContext context)
		{
			context.CodeBuilder.Indent();
