...
namespace Durian.Analysis
{
	...
	/// </summary>
	public abstract class DurianGeneratorWithBuilder : DurianGenerator
	{
		/// <summary>
		/// <see cref="GeneratorPassContext"/> that also provides a <see cref="Analysis.CodeBuilder"/>.
		/// </summary>
		public class BuilderContext : GeneratorPassContext
		{
			/// <summary>
			...
			protected internal BuilderContext(IHintNameProvider? fileNameProvider = default, CSharpParseOptions? parseOptions = default) : base(fileNameProvider, parseOptions)
			{
			...
			) : base(originalContext, generator, targetCompilation, syntaxReceiver, parseOptions, fileNameProvider, services, diagnosticReceiver, logReceiver, cancellationToken)
			{
				CodeBuilder = new(this);
			}
		}
		...
		/// <param name="context"><see cref="BuilderContext"/> to add the source to.</param>
		/// <exception cref="InvalidOperationException"><see cref="DurianGeneratorWithContext{TContext}.IsValid"/> must be <see langword="true"/> in order to add new source.</exception>
		protected void AddSource(string hintName, BuilderContext context)
		{
		...
		/// <param name="context"><see cref="BuilderContext"/> to add the source to.</param>
		/// <exception cref="InvalidOperationException"><see cref="DurianGeneratorWithContext{TContext}.IsValid"/> must be <see langword="true"/> in order to add new source.</exception>
		protected void AddSourceWithOriginal(CSharpSyntaxNode original, string hintName, BuilderContext context)
		{
			ThrowIfHasNoValidData();
		...
		/// <param name="context">Current <see cref="BuilderContext"/>.</param>
		/// <param name="applyInheritdoc">Determines when to apply the <c>&lt;inheritdoc/&gt;</c> tag.</param>
		protected void WriteGeneratedMember(CSharpSyntaxNode generated, IMemberData original, BuilderContext context, GenerateInheritdoc applyInheritdoc = GenerateInheritdoc.WhenPossible)
		{
		...
		/// <param name="context">Current <see cref="BuilderContext"/>.</param>
		/// <param name="applyInheritdoc">Determines when to apply the <c>&lt;inheritdoc/&gt;</c> tag.</param>
		protected void WriteGeneratedMember(string generated, IMemberData original, BuilderContext context, GenerateInheritdoc applyInheritdoc = GenerateInheritdoc.WhenPossible)
		{
		...
		/// <param name="context">Current <see cref="BuilderContext"/>.</param>
		/// <param name="applyInheritdoc">Determines when to apply the <c>&lt;inheritdoc/&gt;</c> tag.</param>
		protected void WriteGeneratedMember(CSharpSyntaxNode generated, ISymbol original, BuilderContext context, GenerateInheritdoc applyInheritdoc = GenerateInheritdoc.WhenPossible)
		{
			WriteGeneratedMember(NodeToString(generated), original, context, applyInheritdoc);
		}
		...
		/// <param name="context">Current <see cref="BuilderContext"/>.</param>
		/// <param name="applyInheritdoc">Determines when to apply the <c>&lt;inheritdoc/&gt;</c> tag.</param>
		protected void WriteGeneratedMember(string generated, ISymbol original, BuilderContext context, GenerateInheritdoc applyInheritdoc = GenerateInheritdoc.WhenPossible)
		{
		...
		/// <param name="generated"><see cref="CSharpSyntaxNode"/> that was generated during the current generation pass.</param>
		/// <param name="context">Current <see cref="BuilderContext"/>.</param>
		protected void WriteGeneratedMember(CSharpSyntaxNode generated, BuilderContext context)
		{
		...
		/// <param name="generated"><see cref="string"/> that was generated during the current generation pass.</param>
		/// <param name="context">Current <see cref="BuilderContext"/>.</param>
		protected void WriteGeneratedMember(string generated, BuilderContext context)
		{
		...
		/// <param name="context">Current <see cref="BuilderContext"/>.</param>
		protected void WriteGeneratedMember(CSharpSyntaxNode generated, string? generatedFrom, BuilderContext context)
		{
		...
		/// <param name="context">Current <see cref="BuilderContext"/>.</param>
		protected void WriteGeneratedMember(string generated, string? generatedFrom, BuilderContext context)
		{
		...
		/// <param name="context">Current <see cref="BuilderContext"/>.</param>
		protected void WriteGeneratedMember(CSharpSyntaxNode generated, string? generatedFrom, string? inheritdoc, BuilderContext context)
		{
		...
		/// <param name="inheritdoc">Text to put in the 'inheritdoc' tag.</param>
		/// <param name="context">Current <see cref="BuilderContext"/>.</param>
		protected void WriteGeneratedMember(string generated, string? generatedFrom, string? inheritdoc, BuilderContext context)
		{
		...
		/// <param name="context">Current <see cref="BuilderContext"/>.</param>
		protected void WriteGeneratedMembers(CSharpSyntaxNode[] generated, BuilderContext context)
		{
		...
		/// <param name="context">Current <see cref="BuilderContext"/>.</param>
		protected void WriteGeneratedMembers(string[] generated, BuilderContext context)
		{
		...
		/// <param name="context">Current <see cref="BuilderContext"/>.</param>
		/// <param name="applyInheritdoc">Determines when to apply the <c>&lt;inheritdoc/&gt;</c> tag.</param>
		protected void WriteGeneratedMembers(CSharpSyntaxNode[] generated, IMemberData original, BuilderContext context, GenerateInheritdoc applyInheritdoc = GenerateInheritdoc.WhenPossible)
		{
		...
		/// <param name="context">Current <see cref="BuilderContext"/>.</param>
		/// <param name="applyInheritdoc">Determines when to apply the <c>&lt;inheritdoc/&gt;</c> tag.</param>
		protected void WriteGeneratedMembers(string[] generated, IMemberData original, BuilderContext context, GenerateInheritdoc applyInheritdoc = GenerateInheritdoc.WhenPossible)
		{
		...
		/// <param name="context">Current <see cref="BuilderContext"/>.</param>
		/// <param name="applyInheritdoc">Determines when to apply the <c>&lt;inheritdoc/&gt;</c> tag.</param>
		protected void WriteGeneratedMembers(CSharpSyntaxNode[] generated, ISymbol original, BuilderContext context, GenerateInheritdoc applyInheritdoc = GenerateInheritdoc.WhenPossible)
		{
			WriteGeneratedMembers(ConvertString(generated), original, context, applyInheritdoc);
		}
		...
		/// <param name="context">Current <see cref="BuilderContext"/>.</param>
		/// <param name="applyInheritdoc">Determines when to apply the <c>&lt;inheritdoc/&gt;</c> tag.</param>
		protected void WriteGeneratedMembers(string[] generated, ISymbol original, BuilderContext context, GenerateInheritdoc applyInheritdoc = GenerateInheritdoc.WhenPossible)
		{
			if (generated.Length == 0)
			{
				return;
		...
		private void WriteGeneratedMember_Internal(string generated, string generatedFrom, BuilderContext context)
		{
		...
		private void WriteGeneratedMember_Internal(string generated, string generatedFrom, string inheritdoc, BuilderContext context)
		{
			context.CodeBuilder.Indent();
