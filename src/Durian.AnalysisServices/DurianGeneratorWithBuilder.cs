...
namespace Durian.Analysis
{
		...
		where TFilter : IGeneratorSyntaxFilterWithDiagnostics
	{
		...
		{
			WriteGeneratedMember(ConvertString(generated), original, applyInheritdocIfPossible);
		}
		...
		/// <param name="applyInheritdocIfPossible">Determines whether to apply the <c>&lt;inheritdoc/&gt;</c> tag if the <paramref name="original"/> has a documentation comment.</param>
		protected void WriteGeneratedMember(string generated, IMemberData original, bool applyInheritdocIfPossible = true)
		{
		...
		/// <param name="applyInheritdocIfPossible">Determines whether to apply the <c>&lt;inheritdoc/&gt;</c> tag if the <paramref name="original"/> has a documentation comment.</param>
		protected void WriteGeneratedMember(CSharpSyntaxNode generated, ISymbol original, bool applyInheritdocIfPossible = true)
		{
			WriteGeneratedMember(ConvertString(generated), original, applyInheritdocIfPossible);
		}
		...
		/// <param name="applyInheritdocIfPossible">Determines whether to apply the <c>&lt;inheritdoc/&gt;</c> tag if the <paramref name="original"/> has a documentation comment.</param>
		protected void WriteGeneratedMember(string generated, ISymbol original, bool applyInheritdocIfPossible = true)
		{
			string generatedFrom = AutoGenerated.GetDurianGeneratedAttribute(original.ToString());
		...
		{
			WriteGeneratedMember(ConvertString(generated));
		}
		...
		{
			WriteGeneratedMember(ConvertString(generated), generatedFrom);
		}
		...
		{
			WriteGeneratedMembers(ConvertString(generated), original, applyInheritdocIfPossible);
		}
		...
		/// <param name="applyInheritdocIfPossible">Determines whether to apply the <c>&lt;inheritdoc/&gt;</c> tag if the <paramref name="original"/> has a documentation comment.</param>
		protected void WriteGeneratedMembers(string[] generated, IMemberData original, bool applyInheritdocIfPossible = true)
		{
		...
		/// <param name="applyInheritdocIfPossible">Determines whether to apply the <c>&lt;inheritdoc/&gt;</c> tag if the <paramref name="original"/> has a documentation comment.</param>
		protected void WriteGeneratedMembers(CSharpSyntaxNode[] generated, ISymbol original, bool applyInheritdocIfPossible = true)
		{
			WriteGeneratedMembers(ConvertString(generated), original, applyInheritdocIfPossible);
		}
		...
		/// <param name="applyInheritdocIfPossible">Determines whether to apply the <c>&lt;inheritdoc/&gt;</c> tag if the <paramref name="original"/> has a documentation comment.</param>
		protected void WriteGeneratedMembers(string[] generated, ISymbol original, bool applyInheritdocIfPossible = true)
		{
			if (generated.Length == 0)
			{
				return;
		...
		{
			return nodes.Select(n => ConvertString(n)).ToArray();
		}

		private static string ConvertString(CSharpSyntaxNode node)
		{
		...
		private static bool TryGetInheritdoc(ISymbol original, bool applyInheritdocIfPossible, [NotNullWhen(true)] out string? inheritdoc)
		{
			if (applyInheritdocIfPossible)
			{
				string? doc = original.GetInheritdocIfHasDocumentation();
		...
		private void WriteGeneratedMember_Internal(string generated, string generatedFrom)
		{
			...
			CodeBuilder.Indent();
			CodeBuilder.AppendLine(generated);
		}
