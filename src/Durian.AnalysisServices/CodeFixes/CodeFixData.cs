...
namespace Durian.Generator.CodeFixes
{
	...
	public readonly struct CodeFixData<T> where T : CSharpSyntaxNode
	{
		...
		/// <summary>
		/// Determines whether this data was successully retrieved.
		/// </summary>
		...
		public bool HasSemanticModel => SemanticModel is not null;
		...
		/// <param name="includeSemanticModel">Determines wheter to include the <see cref="Microsoft.CodeAnalysis.SemanticModel"/> when creating this <see cref="CodeFixData{T}"/>.</param>
