...
/// <summary>
/// Adapts the <see cref="CompilationStartAnalysisContext"/> class to be used as an <see cref="IDurianAnalysisContext"/>.
/// </summary>
public sealed class DurianCompilationStartAnalysisContext : IDurianAnalysisContext
{
	private readonly CompilationStartAnalysisContext _context;

	/// <summary>
	/// Initializes a new instance of the <see cref="DurianCompilationStartAnalysisContext"/> class.
	/// </summary>
	/// <param name="context">Input analysis context.</param>
	/// <exception cref="ArgumentNullException"><paramref name="context"/> is <see langword="null"/>.</exception>
	public DurianCompilationStartAnalysisContext(CompilationStartAnalysisContext context)
	{
		if (context is null)
		{
	...
	{
		_context.RegisterCompilationEndAction(action);
	}
