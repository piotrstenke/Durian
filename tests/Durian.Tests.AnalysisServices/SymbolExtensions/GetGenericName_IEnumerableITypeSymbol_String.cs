...
namespace Durian.Tests.AnalysisServices.AnalysisUtilities
{
	public sealed class GetGenericName_IEnumerableITypeSymbol_String
	{
		...
		public void CanReturnGenericNameWithMultipleTypeArguments()
		{
			...
			Assert.True(new ITypeSymbol[] { arg1.Object, arg2.Object }.GetGenericName("Test") == "Test<int, string>");
		}
		...
		public void ReplacesDotNetPrimitiveWithCSharpKeyword()
		{
			...
			Assert.True(new ITypeSymbol[] { arg.Object }.GetGenericName("Test") == "Test<int>");
		}
		...
		public void ReturnsOnlyGenericPart_When_NameIsNull()
		{
			...
			string genericName = new ITypeSymbol[] { type.Object }.GetGenericName(null);
			Assert.True(genericName.Length > 1 && genericName[0] == '<' && genericName[^1] == '>');
		}

		[Fact]
		public void ReturnsOnlyName_When_TypeArgumentsIsEmpty()
		{
			Assert.True(Array.Empty<ITypeSymbol>().GetGenericName("Test") == "Test");
		}
		...
		public void ReturnsParameterGenericName_When_TypeArgumentsIsIEnumerableITypeParameterSymbol()
		{
			...
			Assert.True(((ITypeSymbol[])parameters).GetGenericName("Test") == "Test<T>");
		}

		[Fact]
		public void ThrowsArgumentNullException_When_TypeArgumentsIsNull()
		{
			Assert.Throws<ArgumentNullException>(() => ((IEnumerable<ITypeSymbol>)null!).GetGenericName("Test"));
		}

		private static bool RunWithSymbol(ITypeSymbol symbol, string expectedArgName)
		{
			return new ITypeSymbol[] { symbol }.GetGenericName("Test") == $"Test<{expectedArgName}>";
		}
	}
}
