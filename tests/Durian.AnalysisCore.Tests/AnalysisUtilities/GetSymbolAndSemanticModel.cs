...
namespace Durian.Tests.AnalysisCore.AnalysisUtilities
{
	public sealed class GetSymbolAndSemanticModel : CompilationTest
	{
		...
		{
			Assert.Throws<ArgumentNullException>(() => Durian.AnalysisUtilities.GetSymbolAndSemanticModel(null!, Compilation));
		}
		...
		public void ThrowsArgumentNullException_When_CompilationIsNull()
		{
			...
			Assert.Throws<ArgumentNullException>(() => Durian.AnalysisUtilities.GetSymbolAndSemanticModel(node, null!));
		}
		...
		public void ThrowsArgumentException_When_SyntaxNodeDoesNotRepresentAnySymbols()
		{
			...
			Assert.Throws<ArgumentException>(() => Durian.AnalysisUtilities.GetSymbolAndSemanticModel(node, Compilation));
		}
		...
		public void ReturnsSemanticModelAndSymbol_When_InputIsValid()
		{
			...
			(SemanticModel newSemanticModel, ISymbol newSymbol) = Durian.AnalysisUtilities.GetSymbolAndSemanticModel(node, Compilation);
