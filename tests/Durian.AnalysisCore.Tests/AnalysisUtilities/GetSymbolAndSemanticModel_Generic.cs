...
namespace Durian.Tests.AnalysisCore.AnalysisUtilities
{
	public sealed class GetSymbolAndSemanticModel_Generic : CompilationTest
	{
		...
		{
			Assert.Throws<ArgumentNullException>(() => Durian.AnalysisUtilities.GetSymbolAndSemanticModel<INamedTypeSymbol>(null!, Compilation));
		}
		...
		public void ThrowsArgumentNullException_When_CompilationIsNull()
		{
			...
			Assert.Throws<ArgumentNullException>(() => Durian.AnalysisUtilities.GetSymbolAndSemanticModel<INamedTypeSymbol>(node, null!));
		}
		...
		public void ThrowsArgumentException_When_SyntaxNodeDoesNotRepresentAnySymbols()
		{
			...
			Assert.Throws<ArgumentException>(() => Durian.AnalysisUtilities.GetSymbolAndSemanticModel<IMethodSymbol>(node, Compilation));
		}
		...
		public void ReturnsSemanticModelAndSymbol_When_InputIsValid()
		{
			...
			(SemanticModel newSemanticModel, ISymbol newSymbol) = Durian.AnalysisUtilities.GetSymbolAndSemanticModel<INamedTypeSymbol>(node, Compilation);
