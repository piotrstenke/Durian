...
namespace Durian.Analysis.Tests.SyntaxNodeExtensions
{
	public sealed class GetMemberData : CompilationTest
	{
		...
		public void ReturnsValidEventData_When_HasMultipleEventFieldsInSingleDeclaration()
		{
			...
			Analysis.Data.EventData? data = e.GetMemberData(Compilation) as Analysis.Data.EventData;
		...
		public void ReturnsValidFieldData_When_HasMultipleFieldsInSingleDeclaration()
		{
			...
			Analysis.Data.FieldData? data = field.GetMemberData(Compilation) as Analysis.Data.FieldData;
		...
		{
			Assert.True(ValidateMember<Analysis.Data.MemberData, MemberDeclarationSyntax>("class Test { int this[int index] { get => 0 }}"));
		}

		[Fact]
		public void ReturnsValidMethodData_When_IsMethod()
		{
			Assert.True(ValidateMember<Analysis.Data.MethodData, MethodDeclarationSyntax>("class Test { void Method() { } }"));
		}
